...
If you device is not supported by this version of plugin consider switching to the [next version (v3.0)](https://github.com/stas-demydiuk/domoticz-zigbee2mqtt-plugin/tree/v3.0)
