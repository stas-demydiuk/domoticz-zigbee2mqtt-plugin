...
class WXKG07LM(AdapterWithBattery):
    def __init__(self, devices):
        ...
        self.switchLeft = SelectorSwitch(devices, 'swt' + str(0), 'action', ' (Left Click)')
        ...
        self.switchRight = SelectorSwitch(devices, 'swt' + str(1), 'click', ' (Right Button)')
        ...
        self.switchBoth = SelectorSwitch(devices, 'swt' + str(2), 'click', ' ( Both Buttons)')
